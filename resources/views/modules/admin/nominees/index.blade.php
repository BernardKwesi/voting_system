...
@section('content')
                    ...
                    <div class="container-xxl">
                        ...
                        <div class="py-3 d-flex align-items-sm-center flex-sm-row flex-column">
                            ...
                            <div class="text-end">
                                <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#addElectionModal"><i class="bi bi-plus-lg me-2" data-bs-toggle="modal" data-bs-target="#exampleLargeModal"></i>New Nominee</button>
...
@include('modules.admin.nominees.modals.add')
@include('modules.admin.nominees.modals.edit')
@endsection
    ...
    columns: [
        {
            ...
            render: function (data, type, row) {
                    return ` <img src="${APP_URL +row.img_url}" class="rounded-circle" width="40" height="40" alt="">`;
            }
        },
        {
            data: "name"
